  ...
  items: [
    {
      ...
      bullets: [
        ...
        'Implementé conectores con Jira, Port para sincronización de entidades.',
      ...
      releaseHistory: [
        ...
        { version: 'v3', title: 'Reportería Power BI' },
        { version: 'v4', title: 'Integraciones con Jira, Port' },
        // { version: 'v5', title: 'Alta y baja automatizadas en ServiceNow' },
        // { version: 'v6', title: 'Gestión de accesos vía GitHub Teams y Azure' },
      ],
    },
    {
    ...
    },
    {
      ...
      title: 'CENFROCAFE — Planta de Beneficio',
      role: 'Full Stack Developer',
      releases: null,
      description:
        'Sistema web para la gestión integral de una planta de beneficio de café: recepción de lotes, análisis físico-sensorial, secado, órdenes de proceso, liquidación, traslados, salidas y control de stock, con trazabilidad de extremo a extremo.',
      contribLabel: '// mi contribución',
      bullets: [
        'Desarrollé el backend en Symfony 8 y PHP 8.5 con arquitectura por módulos y capas de servicio, comando y repositorio para mantener la lógica de negocio desacoplada.',
        'Implementé el flujo del proceso productivo del café: recepción, análisis físico-sensorial, secado, programación y órdenes de proceso, liquidación y salidas.',
        'Construí el control de stock con trazabilidad por lote, reflejando recepciones, traslados y salidas en tiempo real.',
        'Modelé el esquema de datos en MySQL con Doctrine ORM y desarrollé las vistas con Twig y componentes UX Live Component sobre Webpack Encore.',
      ],
      chips: ['Symfony', 'PHP', 'MySQL', 'Doctrine', 'Twig', 'JavaScript', 'Webpack Encore'],
      linkLabel: 'Ver proyecto',
      images: [],
      link: null,
      releaseHistory: [],
